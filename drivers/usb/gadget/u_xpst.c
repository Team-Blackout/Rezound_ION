...
#if defined(CONFIG_MACH_MECHA) || defined(CONFIG_ARM) || defined(CONFIG_ARCH_MSM8960)
...
{
#if defined(CONFIG_MACH_MECHA) || defined(CONFIG_ARM)
	int j;
	uint16_t nv_num;
	uint16_t max_item;
...
#if defined(CONFIG_ARM) || defined(CONFIG_ARCH_APQ8064)
